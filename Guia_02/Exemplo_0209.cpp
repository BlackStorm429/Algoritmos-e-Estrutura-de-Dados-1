/*
Guia_0209 - v0.0. - 20 / 08 / 2022
Author: Lara Brigida Rezende Souza

Para compilar em uma janela de comandos (terminal):
No Linux : g++ -o Guia0201 ./Guia0209.cpp
No Windows: g++ -o Guia0201.exe Guia0209.cpp
		...
		void doSquare() 
		{
			...
			while (step <= 4) 
			{
				...
				if (n > 0) 
				{
					...
					show_Text(msg);
					// USAR <ENTER> DEPOIS QUE LER A MENSAGEM PARA CONTINUAR
				} // end if
				turnRight();
				// tentar passar 'a proxima
				step = step + 1;
...
/*
	...
	// 0.4 01. ( OK ) teste de pegar os marcadores
	// 0.5 01. ( OK ) teste de retornar a quantidade de marcadores coletados
	// 0.6 01. ( OK ) teste de comandos
	// 0.7 01. ( OK ) teste de insercao de arquivos
	// 0.8 01. ( OK ) teste de recebimento de comandos de arquivo
	// 0.9 01. ( OK ) teste de traducao de comandos
*/
